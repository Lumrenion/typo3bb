...
class MessageRepository extends AbstractRepository
{
    ...
    public function setStoragePageIdsFromPluginSettings($defaultQuerySettings = null) {
        ...
        $this->defaultQuerySettings->setStoragePageIds(\TYPO3\CMS\Core\Utility\GeneralUtility::intExplode(',', PluginUtility::_getPluginConfiguration()['persistence']['storagePid']));
    }
